...
class TestGranularity(unittest.TestCase):
    ...
    def test_granularity_seconds(self):
        ...
        self.assertEqual(
            str(Granularity(relativedelta(seconds=3600))), '01:00:00'
        )
    
        self.assertEqual(
            str(Granularity(relativedelta(seconds=43200))), '12:00:00'
        )
    
        self.assertEqual(
            str(Granularity(relativedelta(seconds=86400))), '1 day'
        )
    ...
    def test_granularity_month_dst(self):
        ...
        self.assertEqual(
            before_dst_switch, tzinfo.localize(datetime(2013, 9, 1))
        )
