...
class SchemaBuilder:
    ...
    def build_schema(self, stream):
        ...
        schemadochandler.onstartprefixmapping = \
            generated_schemacontext.startprefixmapping
    ...
    def build_schemacontext(generated_schemacontext):
        ...
        include_handler.on_element_start = \
            generated_schemacontext.start_include
        ...
        simpletype_handler = \
            simpletype_type.create_elementhandler("simpleType")
        simpletype_handler.on_element_start = \
            generated_schemacontext.start_simpletype
        simpletype_handler.on_element_end = \
            generated_schemacontext.endelement
        ...
        restriction_handler = \
            restriction_type.create_elementhandler("restriction")
        restriction_handler.on_element_start = \
            generated_schemacontext.start_restriction
        restriction_handler.on_element_end = \
            generated_schemacontext.endelement

        enumeration_type = XmlElementType(None, None)
        enumeration_type.attributes = set(["value"])
        enumeration_handler = \
            enumeration_type.create_elementhandler("enumeration")
        enumeration_handler.on_element_start = \
            generated_schemacontext.start_enumeration
        enumeration_handler.on_element_end = \
            generated_schemacontext.endelement

        maxlength_type = XmlElementType(None, None)
        maxlength_type.attributes = set(["value"])
        maxlength_handler = \
            maxlength_type.create_elementhandler("maxLength")
        maxlength_handler.on_element_start = \
            generated_schemacontext.start_maxlength
        maxlength_handler.on_element_end = \
            generated_schemacontext.endelement

        mininclusive_type = XmlElementType(None, None)
        mininclusive_type.attributes = set(["value"])
        mininclusive_handler = \
            mininclusive_type.create_elementhandler("minInclusive")
        mininclusive_handler.on_element_start = \
            generated_schemacontext.start_mininclusive
        mininclusive_handler.on_element_end = \
            generated_schemacontext.endelement

        maxinclusive_type = XmlElementType(None, None)
        maxinclusive_type.attributes = set(["value"])
        maxinclusive_handler = \
            maxinclusive_type.create_elementhandler("maxInclusive")
        maxinclusive_handler.on_element_start = \
            generated_schemacontext.start_maxinclusive
        maxinclusive_handler.on_element_end = \
            generated_schemacontext.endelement

        fractiondigits_type = XmlElementType(None, None)
        fractiondigits_handler = \
            fractiondigits_type.create_elementhandler("fractionDigits")
        fractiondigits_handler.on_element_start = \
            generated_schemacontext.start_fractiondigits
        ...
        element_type.attributes = \
            set(["name", "ref", "type", "substitutionGroup",
                "minOccurs", "maxOccurs"])
        element_handler = element_type.create_elementhandler("element")
        element_handler.on_element_start = \
            generated_schemacontext.start_element
        ...
        complextype_handler = \
            complextype_type.create_elementhandler("complexType")
        complextype_handler.on_element_start = \
            generated_schemacontext.start_complextype
        complextype_handler.on_element_end = \
            generated_schemacontext.endelement
        ...
        attribute_handler.on_element_start = \
            generated_schemacontext.start_attribute
        attribute_handler.on_element_end = generated_schemacontext.endelement

        complexcontent_type = XmlElementType(None, None)
        complexcontent_handler = \
            complexcontent_type.create_elementhandler("complexContent")
        complexcontent_handler.on_element_start = \
            generated_schemacontext.start_complexcontent
        complexcontent_handler.on_element_end = \
            generated_schemacontext.endelement

        simplecontent_type = XmlElementType(None, None)
        simplecontent_handler = \
            simplecontent_type.create_elementhandler("simpleContent")
        simplecontent_handler.on_element_start = \
            generated_schemacontext.start_simplecontent
        simplecontent_handler.on_element_end = \
            generated_schemacontext.endelement
        ...
        extension_handler.on_element_start = \
            generated_schemacontext.start_extension
        extension_handler.on_element_end = \
            generated_schemacontext.endelement

        sequence_type = XmlElementType(None, None)
        sequence_handler = sequence_type.create_elementhandler("sequence")
        sequence_handler.on_element_start = \
            generated_schemacontext.start_sequence
        sequence_handler.on_element_end = \
            generated_schemacontext.endelement
        ...
        schema_handler.elementtype.add_child_elementhandlers(
            import_handler, include_handler, simpletype_handler,
            element_handler, complextype_handler)
        list_handler.elementtype.add_child_elementhandlers(
            simpletype_handler)
        simpletype_handler.elementtype.add_child_elementhandlers(
            list_handler, restriction_handler, union_handler)
        restriction_handler.elementtype.add_child_elementhandlers(
            enumeration_handler, maxlength_handler, mininclusive_handler,
            maxinclusive_handler, fractiondigits_handler)
        union_handler.elementtype.add_child_elementhandlers(
            simpletype_handler)
        element_handler.elementtype.add_child_elementhandlers(
            simpletype_handler, complextype_handler)
        attribute_handler.elementtype.add_child_elementhandlers(
            simpletype_handler)
        complextype_handler.elementtype.add_child_elementhandlers(
            attribute_handler, complexcontent_handler, simplecontent_handler,
            sequence_handler, all_handler, choice_handler)
        complexcontent_handler.elementtype.add_child_elementhandlers(
            extension_handler)
        simplecontent_handler.elementtype.add_child_elementhandlers(
            extension_handler)
        extension_handler.elementtype.add_child_elementhandlers(
            sequence_handler, attribute_handler)
        extension_handler.elementtype.add_child_elementhandlers(
            sequence_handler, all_handler)
        all_handler.elementtype.add_child_elementhandlers(
            element_handler)
        sequence_handler.elementtype.add_child_elementhandlers(
            element_handler, choice_handler)
        choice_handler.elementtype.add_child_elementhandlers(
            element_handler)
